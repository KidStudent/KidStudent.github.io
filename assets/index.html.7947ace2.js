import{_ as n,o as s,c as a,a as p}from"./app.5c0a263e.js";const e={},t=p(`<h1 id="加载图片资源到地图中" tabindex="-1"><a class="header-anchor" href="#加载图片资源到地图中" aria-hidden="true">#</a> 加载图片资源到地图中</h1><p>地图上的所有使用的图标以及图片必须经过此加工厂到地图上才可使用，所有图片在staticUtil文件中引入抛出即可</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
