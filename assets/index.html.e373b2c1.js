import{_ as n,o as i,c as e,a as s}from"./app.5c0a263e.js";const d={},l=s(`<h1 id="文档目录结构" tabindex="-1"><a class="header-anchor" href="#文档目录结构" aria-hidden="true">#</a> 文档目录结构</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── node_modules  # 模块依赖
├── public  # 静态资源
│   │   └── logo.png  # favicon
├── src
│   ├── assets  # 字体、图片等静态资源
